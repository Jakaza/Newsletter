...
<head>
    ...
    <title>Subscription ${day}-${month}-${year}</title><!--[if (mso 16)]>
<style type="text/css">
                        ...
                        <tr style="border-collapse:collapse">
                            <td class="es-adaptive" align="center" style="padding:0;Margin:0">
                                <table class="es-header-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:20px;padding-right:20px;background-color:#fb5607"
                                            bgcolor="#fb5607" align="left"><!--[if mso]><table style="width:560px" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://siabnc.stripocdn.email/content/guids/0b4d4496-ec47-4246-b631-d6f524f14af4/images/illustrationemail.png"
                                                                        alt
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://siabnc.stripocdn.email/content/guids/0b4d4496-ec47-4246-b631-d6f524f14af4/images/iconsuccess.png"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="85"></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <b>You have successfully subscribe&nbsp;</b>
                                                                    </h1>
                                                                    <p
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                        HI, you will receive email each and every 4
                                                                        hours</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                        about technology.</p>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                        Feel free to customize your preferences by&nbsp;
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                        <a target="_blank"
                                                                            href="${process.env.BASEHOST}${process.env.UPDATE}/${subcriptionID}"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#0B5394;font-size:16px">change
                                                                            news preferences</a></p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                        If you wish to receive more or less emails</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#3D5CA3;background:#FFFFFF;border-width:2px;display:inline-block;border-radius:10px;width:auto"><a
                                                                            href="${process.env.API_BASEHOST}${process.env.UNSUBSCRIBE}/${subcriptionID}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#3D5CA3;font-size:14px;display:inline-block;background:#FFFFFF;border-radius:10px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:auto;text-align:center;padding:15px 20px 15px 20px;mso-padding-alt:0;mso-border-alt:10px solid #FFFFFF">Unsubscribe</a></span>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table class="es-table-not-adapt es-social"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td valign="top" align="center"
                                                                                ...
                                                                                <a target="_blank"
                                                                                    href="https://twitter.com/ThembaG3"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#0B5394;font-size:16px"><img
                                                                                        src="https://siabnc.stripocdn.email/content/assets/img/social-icons/rounded-gray/twitter-rounded-gray.png"
                                                                            ...
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0"><a
                                                                                    target="_blank"
                                                                                    href="https://www.linkedin.com/in/g-themba-chauke/"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#0B5394;font-size:16px"><img
                                                                                        src="https://siabnc.stripocdn.email/content/assets/img/social-icons/rounded-gray/linkedin-rounded-gray.png"
                                                                ...
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Contact us: <a target="_blank"
                                                                            ...
                                                                            href="tel:0711770423">0711770423</a> | <a
                                                                            target="_blank"
                                                                            href="germanwise10@gmail.com"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#666666;font-size:14px">germanwise10@gmail.com</a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#fafafa" bgcolor="#fafafa" align="center">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px">
                                    <tr style="border-collapse:collapse">
                                        <td style="Margin:0;padding-top:10px;padding-left:20px;padding-right:20px;padding-bottom:30px;background-color:#fb5607"
                                            bgcolor="#fb5607" align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        from company name because you subscribed. If you
                                                                        would not like to receive this email <a
                                                                            target="_blank"
                                                                            ...
                                                                            class="unsubscribe"
                                                                            href="${process.env.API_BASEHOST}${process.env.UNSUBSCRIBE}/${subcriptionID}">unsubscribe
                                                                            here</a>.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
